...
// app (via the src/lib/slots.js re-export shim) and the watchlist worker edge
// function can import it. Keep this file runtime-neutral: no $env, no node or
// Deno APIs, pure functions only.
